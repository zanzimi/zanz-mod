...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    NELITTHER("nelitther", 45, new int[]{4, 7, 9, 4}, 30, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.5f, 5.0f, () -> { return Ingredient.fromItems(ModItems.SLITTHER.get()); }),
    SLITTHER("slitther", 55, new int[]{6, 9, 11, 6}, 35, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 4.5f, 5.7f, () -> { return Ingredient.fromItems(ModBlocks.SLITTHER_BLOCK.get()); });
    ...
    @OnlyIn(Dist.CLIENT)
    public String getName() {return ZanzMod.MOD_ID + ":" + this.name; }
